...
echo ""
echo -e "${YELLOW}  رمز عبور اولیهٔ ادمین (admin@habibazar.com) در همین نصب،${NC}"
echo -e "${YELLOW}  به‌صورت تصادفی ساخته و فقط یک‌بار در لاگ چاپ شده — بگیرش:${NC}"
echo "  sudo -u $APP_USER pm2 logs habibazar --lines 200 --nostream | grep 'Seeded the first admin'"
echo ""
