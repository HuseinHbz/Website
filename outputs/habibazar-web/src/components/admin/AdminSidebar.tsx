...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { labelEn: 'Sales Center (ERP)', labelFa: 'مرکز فروش (ERP)', href: '/admin/sales', icon: '🛒' },
      ...
      { labelEn: 'Document Center (ERP)', labelFa: 'مرکز اسناد (ERP)', href: '/admin/documents', icon: '📄' },
      { labelEn: 'Reporting Center (ERP)', labelFa: 'مرکز گزارش‌ها (ERP)', href: '/admin/reports', icon: '📈' },
