              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
                {post.prev ? (
                  <Link
                    ...
                    className="group flex flex-col gap-1 p-4 rounded-xl border border-border/20 hover:border-accent/40 hover:bg-white/[0.03] transition-all"
                  >
                    <span className="flex items-center gap-1 text-xs text-text-muted group-hover:text-accent transition-colors">
                      <span>←</span>
                ...
                {post.next ? (
                  <Link
                    ...
                    className="group flex flex-col gap-1 p-4 rounded-xl border border-border/20 hover:border-accent/40 hover:bg-white/[0.03] transition-all text-right sm:text-right"
                  >
                    <span className="flex items-center justify-end gap-1 text-xs text-text-muted group-hover:text-accent transition-colors">
