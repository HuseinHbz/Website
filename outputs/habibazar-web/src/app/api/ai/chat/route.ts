  ...
  try {
    ...
    switch (provider) {
      ...
      case 'copilot':
        ...
        break
      case 'conduit':
        // Conduit is OpenAI-compatible; model must use provider/name format e.g. anthropic/claude-sonnet-4-6
        reply = await callChatGPT(
          apiKey,
          apiUrl || 'https://conduit.ozdoev.net/api/v1',
        ...
        break
      default: // chatgpt
        reply = await callChatGPT(apiKey, apiUrl || 'https://api.openai.com/v1', model || 'gpt-4o', messages, systemPrompt)
        break
    }
