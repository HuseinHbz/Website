...
export function CredentialsManager() {
  ...
  const columns: Column<Credential>[] = [
    { key: 'nameEn', labelEn: 'Credential', labelFa: t('colCredential'), render: item => <span className="font-medium text-text-primary">{item.nameEn}</span> },
      ...
      {editing && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
          <div className="bg-background border border-border rounded-2xl w-full max-w-xl p-6 max-h-[90vh] overflow-y-auto">
            <h3 className="text-lg font-bold text-text-primary mb-4">{editing.id ? t('editCredential') : t('newCredential')}</h3>
