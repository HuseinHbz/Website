...
interface SocialLinks { linkedin?: string | null; github?: string | null; twitter?: string | null; instagram?: string | null; telegram?: string | null; whatsapp?: string | null; email?: string | null }
            ...
            <div className="glass-card p-8 h-full">
              ...
              <div className="flex justify-center mb-8">
                <div className="relative">
                  ...
                  {/* Status badge */}
                  <div
                    className="absolute -bottom-4 left-1/2 -translate-x-1/2 whitespace-nowrap px-3 py-1.5 rounded-full text-xs font-semibold border inline-flex items-center gap-1.5"
              ...
              {/* Social Links */}
              {(socialLinks?.linkedin || socialLinks?.github || socialLinks?.twitter || socialLinks?.instagram || socialLinks?.telegram || socialLinks?.whatsapp || socialLinks?.email || contactInfo?.email) && (
                <div className="mt-5 flex flex-wrap gap-2">
                  ...
                  {socialLinks?.whatsapp && (
                    <a href={socialLinks.whatsapp.startsWith('http') ? socialLinks.whatsapp : `https://wa.me/${socialLinks.whatsapp.replace(/\D/g, '')}`} target="_blank" rel="noopener noreferrer"
                      className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium bg-[#25d366]/10 text-[#25d366] hover:bg-[#25d366]/20 transition-colors border border-[#25d366]/20">
